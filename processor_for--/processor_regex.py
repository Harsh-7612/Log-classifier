...
if __name__ == "__main__": #check if file run directly or imported. Code inside this runs only when we are running the current file directly.
    ...
    print(classify_with_regex("Hey this is for none. chill only "))